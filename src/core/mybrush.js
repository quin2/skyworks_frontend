...
//todo: export/bundle these later

export function ColorRGB(r_,g_,b_)
{
...
var ColorHSV =function(h_,s_,v_)
{
...
export function MypaintSurface(canvasIn)
{
	this.r=0;this.g=0;this.b=0;
    ...
    //turn off now while we figure out layering
    /*
    ...
    */
                            ...
                            alpha_eraser, aspect_ratio,  angle )
    {
    	  ...
    	  //does not support 50/50 erase yet
    	  if(alpha_eraser == 1){
...
export function MypaintBrush(brushsetting)
{
  ...
  this.new_stroke = function (surface, x, y)
  {
